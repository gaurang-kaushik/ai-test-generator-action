...
def build_user_prompt(java_code: str, context_file: str = None) -> str:
    ...
    return (
        ...
        "11. DATABASE MOCKING: For Spring Boot Application tests, use @MockBean to mock database connections and prevent real DB calls.\n"
        "12. NO REAL DATABASE: Never let tests connect to real databases - always mock database dependencies.\n"
        "13. JtSpringProjectApplication TESTS: DO NOT call SpringApplication.run() directly - mock all dependencies instead.\n"
        "14. USE @ExtendWith(MockitoExtension.class) for unit tests, NOT @SpringBootTest for database-dependent tests.\n\n"
